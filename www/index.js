...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["App.App"] = $PS["App.App"] || {};
  var exports = $PS["App.App"];
  var Configuring = (function () {
      function Configuring(value0) {
          this.value0 = value0;
      };
      Configuring.create = function (value0) {
          return new Configuring(value0);
      };
      return Configuring;
  })();
...
(function($PS) {
  "use strict";
  $PS["App.Graphics"] = $PS["App.Graphics"] || {};
  var exports = $PS["App.Graphics"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];                
  var render = Control_Monad_Reader_Trans.runReaderT;
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Data.Utils.Array"] = $PS["Data.Utils.Array"] || {};
  var exports = $PS["Data.Utils.Array"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var randomIndex = function (xs) {
      return Effect_Random.randomInt(0)(Data_Array.length(xs) - 1 | 0);
  };
  var randomElem = function (xs) {
      return function __do() {
          var i = randomIndex(xs)();
          return xs[i];
      };
  };
  var randomPairs = function (gs) {
      return Data_Traversable["for"](Effect.applicativeEffect)(Data_Traversable.traversableArray)(gs)(function (g) {
          return function __do() {
              var g2 = randomElem(gs)();
              return new Data_Tuple.Tuple(g, g2);
          };
      });
  };
  var randomlyTake = function (v) {
      return function (v1) {
          if (v === 0) {
          ...
          return function __do() {
              var a = randomElem(v1)();
              var rest = randomlyTake(v - 1 | 0)(v1)();
              return Data_Array.cons(a)(rest);
          };
      };
  };
  exports["randomIndex"] = randomIndex;
  exports["randomlyTake"] = randomlyTake;
  exports["randomPairs"] = randomPairs;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Traversable = $PS["Data.Traversable"];
  var Data_Utils_Array = $PS["Data.Utils.Array"];
  var Effect = $PS["Effect"];
  var Effect_Random = $PS["Effect.Random"];
  ...
  var genome = function (g) {
      ...
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")(ids);
  };
  var geneIdLength = 6;
  var geneAlphabet = "0123456789abcdef";
  var gene = function (size) {
      return function __do() {
          ...
          var bias = generate();
          var i = Data_Utils_Array.randomIndex(ActivationFunction.activationFunctions)();
...
(function($PS) {
  ...
  var edges = function (habitat) {
      ...
      var right = {
          vector: [ 0.0, 1.0 ],
          point: [ 0.0, Data_Int.toNumber(habitat.width) ]
      };
      var left = {
          vector: [ 0.0, 1.0 ],
          point: [ 0.0, 0.0 ]
      ...
      var bottom = {
          vector: [ 1.0, 0.0 ],
          point: [ 0.0, Data_Int.toNumber(habitat.height) ]
      };
      return {
          top: top,
          bottom: bottom,
  ...
  var hitEdge = function (habitat) {
      return function (v) {
          var es = edges(habitat);
          var me = (function () {
              if (v.max.x >= Data_Int.toNumber(habitat.width)) {
                  return new Data_Maybe.Just(es.right);
              };
              if (v.min.x <= 0.0) {
                  return new Data_Maybe.Just(es.left);
              };
              if (v.max.y >= Data_Int.toNumber(habitat.height)) {
                  return new Data_Maybe.Just(es.bottom);
              };
              if (v.min.y <= 0.0) {
                  return new Data_Maybe.Just(es.top);
              };
              if (Data_Boolean.otherwise) {
                  return Data_Maybe.Nothing.value;
              };
              throw new Error("Failed pattern match at Habitat (line 51, column 9 - line 55, column 58): " + [  ]);
          })();
          return me;
      };
  };
  var draw = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
      return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(function __do() {
          ...
          return Graphics_Canvas.fillPath(v.ctx)(Graphics_Canvas.rect(v.ctx)({
              x: 0.0,
              y: 0.0,
              width: Data_Int.toNumber(v.habitat.width),
              height: Data_Int.toNumber(v.habitat.height)
          }))();
      });
  });
  exports["draw"] = draw;
...
(function($PS) {
  ...
  var move = function (c) {
      return {
          color: c.color,
          radius: c.radius,
          pos: Data_Vector.vAdd(Data_EuclideanRing.euclideanRingNumber)(c.pos)(Data_Vector.scale(Data_EuclideanRing.euclideanRingNumber)(c.speed)(c.orientation)),
  ...
  var dispatch = function (v) {
      return function (c) {
          ...
          if (v instanceof Collided) {
              return move(c);
          };
          throw new Error("Failed pattern match at Creature (line 205, column 1 - line 205, column 43): " + [ v.constructor.name, c.constructor.name ]);
      };
  };
  var update = function (a) {
      return function (c) {
          var input = [ Data_Vector.x(Data_Vector.s2)(c.orientation), Data_Vector.y(Data_Vector.s2)(c.orientation) ];
          ...
          var r = Data_Maths.toRads(out[0] * 360.0);
          var o = [ $$Math.cos(r), $$Math.sin(r) ];
          return dispatch(a)({
              color: c.color,
              radius: c.radius,
              pos: c.pos,
              orientation: o,
              vision: {
                  left: Data_Vector.rotate(-30.0)(o),
                  right: Data_Vector.rotate(30.0)(o)
              },
              speed: Data_Ord.min(Data_Ord.ordNumber)(out[1])(4.0),
              brain: c.brain,
              genome: c.genome,
              debug: c.debug,
              hover: c.hover
  ...
  var create = function (habitat) {
      return function (g) {
          var speedE = Effect_Random.randomRange(1.0)(4.0);
          var radiusE = Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(Effect_Random.randomInt(5)(10));
          var posE = function __do() {
              var r = radiusE();
              var x = Effect_Random.randomRange(r)(Data_Int.toNumber(habitat.width) - r)();
              var y = Effect_Random.randomRange(r)(Data_Int.toNumber(habitat.height) - r)();
              return [ x, y ];
          };
          var orientationE = function __do() {
              var x = Effect_Random.randomRange(-1.0)(1.0)();
              var sign = Effect_Random.randomInt(0)(1)();
              var y = 1.0 - Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(x);
              return [ x, (function () {
                  var $32 = sign === 1;
                  if ($32) {
                      return y;
          ...
          var genomeColors = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(function (v) {
              return Color.fromHexString("#" + v.value0.id);
          }))(g);
          var blend = (function () {
              var $41 = Data_Array.foldl(function (a) {
                  return function (c) {
                      return Color.mix(Color.RGB.value)(a)(c)(0.5);
                  };
              })(Color.black);
              return function ($42) {
                  return $41(Data_Array.concat($42));
              };
          })();
          return function __do() {
              var radius = radiusE();
              ...
              var color = Data_Maybe.maybe(Color.black)(blend)(genomeColors);
  ...
  var nextAction = function (habitat) {
      return function (creatures) {
          return function (c) {
              var mc = Data_Array.find(collided(c))(Data_Array["delete"](Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
              ...
              })(Brains_NeuralNetwork.eqNN)))(c)(creatures));
              var bb = boundingBox(c);
              var me = Habitat.hitEdge(habitat)(bb);
              return Data_Maybe.fromMaybe(Move.value)(Control_Alt.alt(Data_Maybe.altMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(HitEdge.create)(me))(Data_Functor.map(Data_Maybe.functorMaybe)(Collided.create)(mc)));
          };
      };
  };
...
(function($PS) {
  ...
  var modify = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Brains.NEAT (line 70, column 1 - line 70, column 42): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var fromNum = function (n) {
      ...
      throw new Error("Failed pattern match at Brains.NEAT (line 63, column 1 - line 63, column 30): " + [ n.constructor.name ]);
  };
          ...
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Random.random))(function (r) {
              ...
              if ($22) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Functor.map(Effect.functorEffect)(fromNum)(Effect_Random.random)))(function (m) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Random.randomInt(0)(v.brainSize.layers - 1 | 0)))(function (li) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Random.randomInt(0)(v.brainSize.neurons - 1 | 0)))(function (ni) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(FFI_NanoID.customAlphabet(Brains_Genome.geneAlphabet)(Brains_Genome.geneIdLength)))(function (_id) {
                                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(modify(m)(g[li][ni])))(function (v1) {
                                      var newGene = {
                                          id: _id,
                                          activationFn: v1.value0.activationFn,
                                          bias: v1.value0.bias,
  ...
  var crossover = function (v) {
      ...
      var mergeLayers = Data_Array.zipWithA(Effect.applicativeEffect)(randompick);
      return Data_Array.zipWithA(Effect.applicativeEffect)(mergeLayers)(v.value0)(v.value1);
  };
  var produceOffspring = function (gs) {
      return function __do() {
          var couples = Data_Utils_Array.randomPairs(gs)();
          var children = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(crossover)(couples)();
          return children;
      };
  };
      ...
      return function (cutoff) {
          return function (creatures) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
                  ...
                  var fit = Data_Array.sortWith(Data_Ord.ordNumber)(fn)(Data_Array.filter(cutoff)(creatures));
                  var genomes = Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                      return v1.genome;
                  })(fit);
                  var elitism = percentageIndexFor(0.1)(fit);
                  var v1 = Data_Array.splitAt(elitism)(genomes);
                  var diff = Data_Array.length(creatures) - Data_Array.length(fit) | 0;
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Utils_Array.randomlyTake(diff)((function () {
                      var $33 = Data_Array["null"](v1.after);
                      if ($33) {
                      ...
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(produceOffspring(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.after)(fillers))))(function (offspring) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(mutate)(offspring))(function (mutated) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Creature.create(v.habitat))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mutated)(v1.before))))(function (newGeneration) {
                                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Array.take(Data_Array.length(creatures))(newGeneration));
                              });
                          });
                      });
                  });
...
(function($PS) {
  ...
  var App_Graphics = $PS["App.Graphics"];
  var Brains_Genome = $PS["Brains.Genome"];
  ...
  var Simulating = (function () {
      ...
      Simulating.value = new Simulating();
      return Simulating;
  })();
  ...
  var spawn = Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList)))(function (v) {
      return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Trans_Class.lift(Control_Monad_RWS_Trans.monadTransRWST(Data_List_Lazy_Types.monoidList))(Effect.monadEffect)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Array.replicate(v.population)(Brains_Genome.network(v.brainSize.layers)(v.brainSize.neurons)))))(function (genomes) {
          return Control_Monad_Trans_Class.lift(Control_Monad_RWS_Trans.monadTransRWST(Data_List_Lazy_Types.monoidList))(Effect.monadEffect)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Creature.create(v.habitat))(genomes));
      });
  });
  ...
  var draw = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(App_Graphics.render(Habitat.draw)(v)))(function () {
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(App_Graphics.render(Data_Foldable.traverse_(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Foldable.foldableArray)(Creature.draw)(v.creatures))(v));
      });
  });
  var cutoff = function (habitat) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Simulation (line 167, column 1 - line 167, column 43): " + [ habitat.constructor.name, c.constructor.name ]);
      };
  };
  var simStep = function (dictPartial) {
      return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList)))(function (v) {
          return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_State_Class.get(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList)))(function (v1) {
              var next = (function () {
                  var $24 = v1.step === (60 * v.ttlGen | 0);
                  if ($24) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Writer_Class.tell(Control_Monad_RWS_Trans.monadTellRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(Data_List_Lazy.singleton({
                          elites: [  ],
                          creatures: v1.creatures,
                          genomes: Data_Map_Internal.empty,
                          scores: Data_Map_Internal.empty
                      })))(function () {
                          return Control_Monad_State_Class.modify_(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(function (v2) {
                              var $25 = {};
                              for (var $26 in v2) {
                              ...
                              $25.state = Evolving.value;
                              $25.step = 0;
                              return $25;
                          });
                      });
                  };
                  var actions = Data_Functor.mapFlipped(Data_Functor.functorArray)(v1.creatures)(Creature.nextAction(v.habitat)(v1.creatures));
                  return Control_Monad_State_Class.modify_(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(function (v2) {
                      var $28 = {};
                      for (var $29 in v2) {
                      ...
                      $28.step = v1.step + 1 | 0;
                      $28.creatures = Data_Array.zipWith(Creature.update)(actions)(v1.creatures);
                      return $28;
                  });
              })();
              var evolve = Control_Monad_Trans_Class.lift(Control_Monad_RWS_Trans.monadTransRWST(Data_List_Lazy_Types.monoidList))(Effect.monadEffect)(Control_Monad_Reader_Trans.runReaderT(Brains_NEAT.evolve(fitness(v.habitat))(cutoff(v.habitat))(v1.creatures))(v));
              var $$switch = (function () {
                  if (v1.state instanceof Start) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Debug.traceM()(Control_Monad_RWS_Trans.monadRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))("Starting Sim:"))(function () {
                          return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(spawn)(function (initialPopulation) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_State_Class.modify_(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(function (v2) {
                                  var $32 = {};
                                  for (var $33 in v2) {
                                  ...
                                  $32.currentGen = 0;
                                  $32.step = 0;
                                  $32.creatures = initialPopulation;
                                  $32.state = Simulating.value;
                                  return $32;
                              }))(simStep);
                          });
                      });
                  };
                  if (v1.state instanceof Evolving) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Debug.traceM()(Control_Monad_RWS_Trans.monadRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))("Evolving gen: " + Data_Show.show(Data_Show.showInt)(v1.currentGen)))(function () {
                          return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(evolve)(function (nextGen) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_State_Class.modify_(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(function (v2) {
                                  var $35 = {};
                                  for (var $36 in v2) {
                                  ...
                                  $35.currentGen = v1.currentGen + 1 | 0;
                                  $35.creatures = nextGen;
                                  $35.state = Simulating.value;
                                  return $35;
                              }))(simStep);
                          });
                      });
                  };
                  if (v1.state instanceof Simulating) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(next)(simStep);
                  };
                  if (v1.state instanceof Animation && v1.state.value0 instanceof Paused) {
                      return simStep();
                  };
                  if (v1.state instanceof Animation && v1.state.value0 instanceof Running) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Trans_Class.lift(Control_Monad_RWS_Trans.monadTransRWST(Data_List_Lazy_Types.monoidList))(Effect.monadEffect)(App_Graphics.render(draw)({
                          creatures: v1.creatures,
                          habitat: v.habitat,
                          ctx: v.ctx,
                          window: v.window
                      })))(function () {
                          return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Effect.bindEffect)(Data_List_Lazy_Types.monoidList))(Control_Monad_Trans_Class.lift(Control_Monad_RWS_Trans.monadTransRWST(Data_List_Lazy_Types.monoidList))(Effect.monadEffect)(Web_HTML_Window.requestAnimationFrame(Data_Functor["void"](Effect.functorEffect)(Control_Monad_RWS_Trans.runRWST(next)(v)(v1)))(v.window)))(function () {
                              return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(Data_Unit.unit);
                          });
                      });
                  };
                  return simStep();
              })();
              var $40 = v1.currentGen !== v.totalGens;
              if ($40) {
                  return $$switch;
              };
              return Control_Monad_State_Class.modify_(Control_Monad_RWS_Trans.monadStateRWST(Effect.monadEffect)(Data_List_Lazy_Types.monoidList))(function (v2) {
...
(function($PS) {
  ...
  var draw = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(function __do() {
          ...
          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Unit.unit))(function ($8) {
              return Creature.draw(scaled($8));
          })(v.creature);
      });
  });
          ...
          return function (s) {
              return function (v1) {
                  return function (v2) {
                      ...
                      if (v instanceof Reset) {
                          return function __do() {
                              ...
                              var width = Data_Functor.map(Effect.functorEffect)((function () {
                                  ...
                                  return function ($28) {
                                      return $27(Data_Int.fromString($28));
                                  };
                              ...
                              var height = Data_Functor.map(Effect.functorEffect)((function () {
                                  ...
                                  return function ($30) {
                                      return $29(Data_Int.fromString($30));
                                  };
                              ...
                              var n = Data_Functor.map(Effect.functorEffect)((function () {
                                  ...
                                  return function ($32) {
                                      return $31(Data_Int.fromString($32));
                                  };
                              ...
                              return Effect_Ref.modify_(function (v3) {
                                  ...
                                  $21.appState = new App_App.Configuring({
                                      population: n,
                                      totalGens: 100,
                                      ttlGen: 60,
                                      mutationRate: 0.1,
                      ...
                      throw new Error("Failed pattern match at Simulation.UI (line 39, column 5 - line 39, column 35): " + [ v.constructor.name, s.constructor.name, v1.constructor.name, v2.constructor.name ]);
                  };
              };
          };
      };
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var width = Data_Functor.map(Effect.functorEffect)((function () {
          ...
          return function ($3) {
              return $2(Data_Int.fromString($3));
          };
      })())(Web_HTML_HTMLInputElement.value(Data_Maybe.fromJust()(Web_HTML_HTMLInputElement.fromElement(wInput))))();
      var height = Data_Functor.map(Effect.functorEffect)((function () {
          var $4 = Data_Maybe.fromJust();
          return function ($5) {
              return $4(Data_Int.fromString($5));
          };
      })())(Web_HTML_HTMLInputElement.value(Data_Maybe.fromJust()(Web_HTML_HTMLInputElement.fromElement(hInput))))();
      var n = Data_Functor.map(Effect.functorEffect)((function () {
          var $6 = Data_Maybe.fromJust();
          return function ($7) {
              return $6(Data_Int.fromString($7));
          };
      })())(Web_HTML_HTMLInputElement.value(Data_Maybe.fromJust()(Web_HTML_HTMLInputElement.fromElement(cInput))))();
      ...
      var state = Effect_Ref["new"]({
          simulation: Simulation.simStep(),
          appState: new App_App.Configuring(simConfig),
          inspector: {
              creature: Data_Maybe.Nothing.value
          }
      })();
      var env = {
          state: state,
      ...
      var eff = function __do() {
          ...
          return Control_Monad_RWS_Trans.runRWST(Simulation.simStep())(Record.merge()()({
              ctx: ctx,
              window: w
          })(simConfig))({
              step: 0,
              currentGen: 0,
              state: Simulation.Start.value,
              creatures: [  ],
              genomes: Data_Map_Internal.empty
          })();
      };
