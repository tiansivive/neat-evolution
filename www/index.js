          ...
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Web_Event_EventTarget.eventListener(function (e) {
              return function __do() {
                  ...
                  if (mp instanceof Data_Maybe.Nothing) {
                      return Effect_Console.log("Could not calculate coordinates for mouse event")();
                  };
                  ...
                  throw new Error("Failed pattern match at Simulation (line 70, column 7 - line 72, column 91): " + [ mp.constructor.name ]);
              };
          }));
      });
  })();
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var canvasEl = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromJust())(Web_DOM_NonElementParentNode.getElementById("canvas")(Web_DOM_Document.toNonElementParentNode(Web_HTML_HTMLDocument.toDocument(doc))))();
      ...
      var target = Web_HTML_HTMLCanvasElement.toEventTarget(Data_Maybe.fromJust()(Web_HTML_HTMLCanvasElement.fromElement(canvasEl)));
      ...
      return Data_Functor["void"](Effect.functorEffect)(Web_HTML_Window.requestAnimationFrame(Control_Monad_Reader_Trans.runReaderT(Simulation.init(nCreatures))(env))(w))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();
