...
(function($PS) {
  ...
  var draw = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
      return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Class.monadEffectEffect))(function __do() {
          ...
          return Graphics_Canvas.fillPath(v.ctx)(Graphics_Canvas.rect(v.ctx)({
              x: 0.0,
              y: 0.0,
              width: Data_Int.toNumber(v.board.width),
              height: Data_Int.toNumber(v.board.height)
          }))();
      });
  });
  var checkOutOfBounds = function (v) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Data_Identity.monadIdentity)))(function (v1) {
          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Data_Identity.applicativeIdentity))(v.max.x >= Data_Int.toNumber(v1.board.width) || (v.min.x <= 0.0 || (v.max.y >= Data_Int.toNumber(v1.board.height) || v.min.y <= 0.0)));
      });
  };
  exports["draw"] = draw;
...
(function($PS) {
  ...
  var showPos = Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
  ...
  })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber));
...
(function($PS) {
  ...
  var fromReader = function (dictMonad) {
      var $1 = Control_Monad_Reader_Class.asks(Control_Monad_Reader_Trans.monadAskReaderT(dictMonad));
      return function ($2) {
          return $1(Control_Monad_Reader.runReader($2));
      };
  };
...
(function($PS) {
  ...
  var create = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
      ...
      var posE = function __do() {
          var r = radiusE();
          var x = Effect_Random.randomRange(r)(Data_Int.toNumber(v.board.width) - r)();
          var y = Effect_Random.randomRange(r)(Data_Int.toNumber(v.board.height) - r)();
      ...
      return function (c) {
          ...
          if (v instanceof Simulation_Types.HitEdge) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Random.randomRange(0.0)(360.0)))(function (angle) {
                  ...
                  var test = move(rc);
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Simulation_Types.fromReader(Effect.monadEffect)(Board.checkOutOfBounds(boundingBox(test))))(function (out) {
                      if (out) {
                          return action(Simulation_Types.HitEdge.value)(c);
                      };
                      return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(move(rc));
                  });
              });
          };
          throw new Error("Failed pattern match at Creature (line 106, column 1 - line 106, column 44): " + [ v.constructor.name, c.constructor.name ]);
      };
  };
  var update = function (c) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Simulation_Types.fromReader(Effect.monadEffect)(Board.checkOutOfBounds(boundingBox(c))))(function (out) {
          if (out) {
              return action(Simulation_Types.HitEdge.value)(c);
          };
          if (!out) {
              return action(Simulation_Types.Move.value)(c);
          };
          throw new Error("Failed pattern match at Creature (line 135, column 5 - line 137, column 31): " + [ out.constructor.name ]);
      });
  };
...
(function($PS) {
              ...
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.modify(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Board.draw)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Foldable.sequence_(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Creature.draw)(updated)))(function () {
                          return Data_Functor["void"](Control_Monad_Reader_Trans.functorReaderT(Effect.functorEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Web_HTML_Window.requestAnimationFrame(Control_Monad_Reader_Trans.runReaderT(step)(v))(v.window)));
                      });
                  });
              });
          });
      ...
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Web_UIEvent_MouseEvent.fromEvent(evt))(function (e) {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLCanvasElement.toHTMLElement)(Control_Bind.bind(Data_Maybe.bindMaybe)(Web_Event_Event.target(evt))(Web_HTML_HTMLCanvasElement.fromEventTarget)))(function (l) {
              ...
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(function __do() {
                  ...
                  Effect_Console.log("Coordinates: " + Data_Show.show(Geometry.showPos)(p))();
                  return p;
              });
          });
      });
  };
  var handleMouseEvents = function (dictPartial) {
      return function (state) {
          return function (action) {
              return function (e) {
                  return function __do() {
                      var p = Data_Maybe.fromJust()(coordinates(e))();
                      var v = Effect_Ref.read(state)();
                      return Effect_Ref.modify_(function (v1) {
                          return {
                              creatures: Data_Functor.map(Data_Functor.functorArray)(action(e)(p))(v.creatures)
                          };
                      })(state)();
                  };
              };
  ...
  var mouseOverListener = function (dictPartial) {
      return function (s) {
          return Web_Event_EventTarget.eventListener(handleMouseEvents()(s)(toggleDebugOptions));
      };
  };
  var clickListener = function (dictPartial) {
      return function (s) {
          return Web_Event_EventTarget.eventListener(handleMouseEvents()(s)(toggleDebugOptions));
      };
  };
  exports["clickListener"] = clickListener;
  exports["mouseOverListener"] = mouseOverListener;
  exports["init"] = init;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  ...
  var main = function __do() {
      ...
      var cb = Data_Maybe.maybe(Effect_Console.log("No canvas element found!"))(function (canvas) {
          return function __do() {
              ...
              return Control_Monad_Reader_Trans.runReaderT(Simulation.init(nCreatures))({
                  state: state,
                  ctx: ctx,
                  window: w,
                  board: {
      ...
      Data_Functor["void"](Effect.functorEffect)(Web_HTML_Window.requestAnimationFrame(cb)(w))();
      ...
      var cl = Simulation.clickListener()(state)();
      var mml = Simulation.mouseOverListener()(state)();
      Web_Event_EventTarget.addEventListener(Web_HTML_Event_EventTypes.click)(cl)(true)(target)();
      return Web_Event_EventTarget.addEventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(mml)(true)(target)();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();
