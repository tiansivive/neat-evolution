                  ...
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(spawn(v1.ui.value0.population))(function ($$new) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(updateCanvas(v.window)(v1.ui.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.modify_(function (v2) {
                              ...
                              $33.creatures = $$new;
                              $33.selected = [  ];
                              $33.closeUp = Data_Maybe.Nothing.value;
                              $33.habitat = v1.ui.value0.habitat;
                              $33.ui = Simulation_Types.Running.value;
                              return $33;
                          })(v.state)))(step);
                      });
                  });
          ...
          return function (s) {
              return function (v1) {
                  return function (v2) {
                      ...
                      throw new Error("Failed pattern match at Simulation.UI (line 27, column 5 - line 27, column 59): " + [ v.constructor.name, s.constructor.name, v1.constructor.name, v2.constructor.name ]);
                  };
              };
          };
      };
