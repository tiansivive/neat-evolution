...
(function($PS) {
  ...
  var ordNN = {
      compare: function (v) {
          return function (v1) {
              return Data_Ord.compare(Data_Ord.ordString)(v.value0.id)(v1.value0.id);
          };
      },
      Eq0: function () {
          return eqNN;
...
(function($PS) {
  ...
  var dispatch = function (v) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Creature (line 188, column 1 - line 188, column 47): " + [ v.constructor.name, c.constructor.name ]);
      };
  };
  var create = function (g) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
              ...
              var genomeColors = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(function (v2) {
                  return Color.fromHexString("#" + v2.value0.id);
              }))(g);
              var blend = (function () {
                  var $53 = Data_Array.foldl(function (a) {
                      return function (c) {
                          return Color.mix(Color.RGB.value)(a)(c)(0.5);
                      };
                  })(Color.black);
                  return function ($54) {
                      return $53(Data_Array.concat($54));
                  };
              })();
              return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(function __do() {
                  var radius = radiusE();
...
(function($PS) {
  ...
  var modify = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Brains.NEAT (line 58, column 1 - line 58, column 42): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var fromNum = function (n) {
      ...
      throw new Error("Failed pattern match at Brains.NEAT (line 51, column 1 - line 51, column 30): " + [ n.constructor.name ]);
  };
      ...
      return function (cutoff) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
                  ...
                  var genomes = Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                      return v2.genome;
                  })(fit);
                  var elitism = percentageIndexFor(0.1)(fit);
                  var v2 = Data_Array.splitAt(elitism)(genomes);
                  var diff = Data_Array.length(v1.creatures) - Data_Array.length(fit) | 0;
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Utils_Array.randomlyTake(diff)(v2.after)))(function (fillers) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(produceOffspring(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.after)(fillers))))(function (offspring) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(mutate)(offspring))(function (mutated) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Creature.create)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mutated)(v2.before)))(function (newGeneration) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Debug.traceM()(Control_Monad_Reader_Trans.monadReaderT(Effect.monadEffect))("\x0aEvolving!"))(function () {
                                      var groups = Data_Array.groupAllBy(function (c1) {
                                          return function (c2) {
                                              return Data_Ord.compare(Brains_NeuralNetwork.ordNN)(c1.brain)(c2.brain);
                                          };
                                      })(newGeneration);
                                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable["for"](Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Traversable.traversableArray)(groups)(function (g) {
                                          var v3 = (Data_Array_NonEmpty.head(g)).brain;
                                          return Debug.traceM()(Control_Monad_Reader_Trans.monadReaderT(Effect.monadEffect))("For genome: " + (v3.value0.id + (": group size -> " + Data_Show.show(Data_Show.showInt)(Data_Array_NonEmpty.length(g)))));
                                      }))(function () {
                                          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Array.take(Data_Array.length(v1.creatures))(newGeneration));
                                      });
                                  });
                              });
                          });
...
(function($PS) {
  ...
  var spawn = function (v) {
      return function (n) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Array.replicate(n)(Brains_Genome.network(v.layers)(v.neurons)))))(function (genomes) {
              return Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Creature.create)(genomes);
          });
      };
  };
  ...
  var cutoff = function (habitat) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Simulation (line 157, column 1 - line 157, column 47): " + [ habitat.constructor.name, c.constructor.name ]);
      };
  };
  var step = function (dictPartial) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Creature.update)(v1.creatures))(function (updated) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.modify(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Habitat.draw)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Foldable.traverse_(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Foldable.foldableArray)(Creature.draw)(updated))(function () {
  ...
  var loop = function (dictPartial) {
      ...
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
              ...
              throw new Error("Failed pattern match at Simulation (line 120, column 5 - line 136, column 13): " + [ v1.simulation.constructor.name ]);
          });
      });
  };
