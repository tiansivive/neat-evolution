...
(function($PS) {
  ...
  var loop = function (dictPartial) {
      ...
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
              var v2 = Debug.spy()("ui")(v1.ui);
              if (v2 instanceof Simulation_Types.Init) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(spawn(v2.value0.population))(function ($$new) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(updateCanvas(v.window)(v2.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.modify_(function (v3) {
                              var $34 = {};
                              for (var $35 in v3) {
                              ...
                              $34.creatures = $$new;
                              $34.selected = [  ];
                              $34.closeUp = Data_Maybe.Nothing.value;
                              $34.habitat = v2.value0.habitat;
                              $34.ui = Simulation_Types.Running.value;
                              return $34;
                          })(v.state)))(step);
                      });
                  });
      ...
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Web_Event_EventTarget.eventListener(function (e) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Simulation (line 76, column 7 - line 78, column 53): " + [ mp.constructor.name ]);
              };
          }));
      });
  })();
...
(function($PS) {
  ...
  var handleReset = (function () {
              ...
              return function (v) {
                  return function __do() {
                      ...
                      var width = Data_Functor.map(Effect.functorEffect)((function () {
                          ...
                          return function ($11) {
                              return $10(Data_Int.fromString($11));
                          };
                      ...
                      var height = Data_Functor.map(Effect.functorEffect)((function () {
                          ...
                          return function ($13) {
                              return $12(Data_Int.fromString($13));
                          };
                      ...
                      var n = Data_Functor.map(Effect.functorEffect)((function () {
                          ...
                          return function ($15) {
                              return $14(Data_Int.fromString($15));
                          };
                      ...
                      return Effect_Ref.modify_(function (v1) {
                          ...
                          $4.ui = new Simulation_Types.Init({
      ...
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Web_Event_EventTarget.eventListener(handler(v.window)(v.state)));
      });
  })();
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var handlerBtn = Control_Monad_Reader_Trans.runReaderT(Simulation_UI.handleReset)(env)();
