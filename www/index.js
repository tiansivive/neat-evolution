...
(function($PS) {
  ...
  var dispatch = function (v) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Creature (line 183, column 1 - line 183, column 47): " + [ v.constructor.name, c.constructor.name ]);
      };
  };
  var create = function (g) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
              ...
              var blend = (function () {
                  var $52 = Data_Array.foldl(function (a) {
                      return function (c) {
                          return Color.mix(Color.RGB.value)(a)(c)(0.5);
                      };
                  })(Color.black);
                  return function ($53) {
                      return $52(Data_Array.concat($53));
                  };
              })();
              return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(function __do() {
                  var radius = radiusE();
      ...
      return function (cutoff) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (v) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(v.state)))(function (v1) {
                  ...
                  var diff = (Data_Array.length(v1.creatures) - Data_Array.length(genomes) | 0) - Data_Array.length(v2.before) | 0;
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Data_Utils_Array.randomlyTake(diff)(genomes)))(function (fillers) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(produceOffspring(Data_Semigroup.append(Data_Semigroup.semigroupArray)(genomes)(fillers))))(function (offspring) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(mutate)(offspring))(function (mutated) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Creature.create)(mutated))(function (newGeneration) {
                                  var all = Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.before)(newGeneration);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Debug.traceM()(Control_Monad_Reader_Trans.monadReaderT(Effect.monadEffect))("\x0aEvolving!"))(function () {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Traversable["for"](Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Traversable.traversableArray)(groups)(function (g) {
                                          ...
                                          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect.applicativeEffect))(Data_Array.take(Data_Array.length(v1.creatures))(all));
                                      });
                                  });
                              });
                          });
